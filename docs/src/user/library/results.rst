...
:meth:`ExperimentBuilder().build_view_from() <orion.core.io.experiment_builder.ExperimentBuilder.build_view_from>`.
...
You can pass queries to :meth:`fetch_trials() <orion.core.worker.experiment.Experiment.fetch_trials>`,
...
You can find more in formation on the object :class:`Experiment <orion.core.worker.experiment.Experiment>` in the code
reference section.
