            ...
            <div>
                <div className="trial" id="tabsty">
                    <Pivot defaultSelectedKey={"0"} className="detial-title">
                        ...
                        <PivotItem headerText="Smart Suggest" itemIcon="StackedLineChart" key="5">
                            {/* *why this graph has small footprint? */}
                            <div>  You can reduce the search space to speed the hyperparameter search, reduce learning rate 0.01-0.05</div>
                        </PivotItem>
                    </Pivot>
                </div>
                {/* trial table list */}
