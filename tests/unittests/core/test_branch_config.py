...
@pytest.fixture
def child_config(parent_config, pdatabase):
...
class TestResolutions(object):
    ...
    def test_name_experiment(
        self, bad_exp_parent_config, bad_exp_child_config, pdatabase
    ):
        ...
        pdatabase.write("experiments", bad_exp_parent_config)
        pdatabase.write("experiments", bad_exp_child_config)
...
class TestResolutionsWithMarkers(object):
    ...
    def test_name_experiment_version_update(
        self, parent_config, child_config, pdatabase
    ):
    ...
    def test_name_experiment_name_change(self, parent_config, child_config, pdatabase):
